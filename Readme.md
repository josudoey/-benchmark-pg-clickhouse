...
goos: darwin
goarch: arm64
pkg: github.com/josudoey/benchmark-pg-clickhouse/driver
BenchmarkClickHouseInsert-8          100          83611050 ns/op        35709481 B/op     793825 allocs/op
PASS
ok      github.com/josudoey/benchmark-pg-clickhouse/driver      8.486s
...
PASS
ok      github.com/josudoey/benchmark-pg-clickhouse/driver      1.181s
```
...
PASS
ok      github.com/josudoey/benchmark-pg-clickhouse/driver      191.895s
...
PASS
ok      github.com/josudoey/benchmark-pg-clickhouse/driver      0.924s
```
...
PASS
ok      github.com/josudoey/benchmark-pg-clickhouse/driver      141.708s
...
PASS
ok      github.com/josudoey/benchmark-pg-clickhouse/driver      28.779s
```
...
PASS
ok      github.com/josudoey/benchmark-pg-clickhouse/driver      1864.889s
...
PASS
ok      github.com/josudoey/benchmark-pg-clickhouse/driver      25.785s
```